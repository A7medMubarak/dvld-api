...
namespace DVLD.Business.Interfaces.Services
{
    public interface IUserService
    {
        ...
        Task<UserDetailedDto?> GetDetailedByUserIdAsync(int userId, CancellationToken cancellationToken = default);
        Task<UserDetailedDto?> GetDetailedByPersonIdAsync(int personId, CancellationToken cancellationToken = default);
